          ...
          {filtered.map((inv) => {
            ...
            return (
              <div
                ...
                className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 px-4 py-3 hover:bg-[var(--muted)] transition-colors group cursor-pointer"
              >
                {/* Main info */}
                ...
                <div className="flex items-center gap-2 sm:gap-3 shrink-0">
                  ...
                  <span className={`hidden sm:flex items-center gap-1 text-xs ${isOverdue ? "text-red-500" : isDueSoon ? "text-orange-500" : "text-[var(--ink-muted)]"}`}>
